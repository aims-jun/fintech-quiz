...
export const allQuizzes: Quiz[] = [
  ...
  },
  {
    id: 6,
    question:
      "에임스가 2025년에 이름을 올린 혁신프리미어 1000은 유망 핀테크 스타트업 1,000개를 선발하는 프로그램이다.",
    answer: false,
    explanation:
      "혁신프리미어 1000 기업 산업통상부, 금융위원회 등 13개 정부부처에서 다양한 산업에 걸쳐 유망 기업을 선정하였으며, 에임스는 금융위원회 추천 11개 기업중 하나로 선정되었습니다.",
  },
  {
    id: 7,
    question:
